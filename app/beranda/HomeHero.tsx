...
const HomeHero = () => {
  return (
    <div className='h-[460px] md:h-[560px] lg:h-[650px] custom-container py-18 relative overflow-hidden'>
      <div className='w-[120px] h-[310px] bg-secondary-green absolute -left-22 md:-left-8 lg:left-0 top-0 -z-10' />
      <div className='w-[220px] h-[310px] bg-secondary-red absolute -right-48 md:-right-32 lg:right-0 bottom-0 bg-[url("/patterns/small-pattern-vertical.png")] -z-10' />
